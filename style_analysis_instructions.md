...
3. THIẾT LẬP CÔNG THÁI HỌC: Xác định `bodyFontSize` (17.5px - 20px), `lineHeight` (1.5 - 1.65) và `textAlign` (`justify` cho văn xuôi, `left` cho kỹ thuật/danh mục).
...
- `lineHeight`: Chọn '1.5', '1.52', '1.55', '1.57', '1.6', '1.62', '1.65' (Hãy tìm điểm cân bằng giữa cách trình bày của bản gốc, và kích cỡ font chữ mà bạn chọn để đưa ra chọn lựa tốt nhất).
...

{
  ...
  "lineHeight": "<1.5 | 1.52 | 1.55 | 1.57 | 1.6 | 1.62 | 1.65>",
